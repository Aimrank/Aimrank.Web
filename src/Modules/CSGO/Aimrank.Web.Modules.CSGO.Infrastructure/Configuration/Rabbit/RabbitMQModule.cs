...
using Aimrank.Web.Modules.CSGO.Infrastructure.Application.Events.MatchCanceled;
using Aimrank.Web.Modules.CSGO.Infrastructure.Application.Events.MatchFinished;
using Autofac;

namespace Aimrank.Web.Modules.CSGO.Infrastructure.Configuration.Rabbit
{
