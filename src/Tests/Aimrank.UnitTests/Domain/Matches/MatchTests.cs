...
namespace Aimrank.UnitTests.Domain.Matches
{
    public class MatchTests
    {
        ...
        public void Finish_UpdatesPlayersRating_WhenTerroristsWin()
        {
            ...
            _match.UpdatePlayerStats(P1Steam, new MatchPlayerStats(16, 0, 0, 32));
        ...
        public void Finish_UpdatesPlayersRating_WhenCounterTerroristsWin()
        {
            ...
            _match.UpdatePlayerStats(P2Steam, new MatchPlayerStats(16, 0, 0, 32));
        ...
        public void Finish_UpdatesPlayersRating_WhenDraw()
        {
            ...
            _match.UpdatePlayerStats(P1Steam, new MatchPlayerStats(15, 0, 15, 30));
            _match.UpdatePlayerStats(P2Steam, new MatchPlayerStats(15, 0, 15, 30));
